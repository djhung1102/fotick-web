...
const TestimonialGridCards = () => {
  return (
    <section id="support" className="bg-white dark:bg-gray-900 scroll-smooth">
          ...
          <div className="space-y-6">
            ...
            <figure className="p-6 bg-gray-50 rounded dark:bg-gray-800">
              <blockquote className="text-sm text-gray-500 dark:text-gray-400">
                ...
                <p className="my-4">
                  I recently got my hands on Flowbite Pro, and holy crap, Im
...
export default TestimonialGridCards;
